...
replace_ddot = $(subst $(double_dot),_ddot_,$(1))
...
###
# Shorthand for $(Q)$(MAKE) -f scripts/Makefile.build.mk obj=
# Usage:
# $(Q)$(MAKE) $(build)=dir
build := -f $(srctree)/scripts/Makefile.build.mk obj
...
if_changed = $(if $(strip $(any-prereq) $(arg-check)),                       \
	@echo ------ if_changed \
	@echo --------- any-prereq=$(any-prereq) \
	@echo --------- KBUILD_NOCMDDEP=$(KBUILD_NOCMDDEP) \
	@echo --------- arg-check=$(arg-check) \
	@set -e;                                                             \
	$(echo-cmd) $(cmd_$(1));                                             \
