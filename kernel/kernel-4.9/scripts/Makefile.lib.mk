...
$(info --------- asflags-y=$(asflags-y))
$(info --------- ccflags-y=$(ccflags-y))
$(info --------- cppflags-y=$(cppflags-y))
$(info --------- ldflags-y=$(ldflags-y))
$(info --------- subdir-asflags-y=$(subdir-asflags-y))
